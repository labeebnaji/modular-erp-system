"""
Complete Sales Order Management Widget
"""
...
class SalesOrderManagementWidget(QWidget):
    """Widget for managing sales orders"""
    ...
    def init_ui(self):
        self.setWindowTitle(tr('modules.sales') + " - " + "Orders")
        main_layout = QVBoxLayout(self)
        
        # Order Header Form
        header_group = QGroupBox("Order Header")
        ...
        self.load_customers()
        header_layout.addRow(QLabel("Customer:"), self.customer_combo)
        ...
        self.status_combo.addItem("Fulfilled", 2)
        ...
        self.save_button.clicked.connect(self.save_sales_order)
        ...
        self.delete_button.clicked.connect(self.delete_sales_order)
        ...
        self.orders_table.setHorizontalHeaderLabels([
            "ID", "Order No", "Customer", tr('common.date'), 
    ...
    def load_customers(self):
        ...
        for customer in customers:
            self.customer_combo.addItem(customer.name_ar, customer.id)
    ...
    def save_sales_order(self):
        ...
        try:
            ...
            # Create order (simplified - you'll need to implement this in service)
            QMessageBox.information(self, tr('common.success'), 
                                  f"Order {order_no} saved successfully!\nTotal: {total_amount:.2f}")
    ...
    def load_sales_orders(self):
        ...
        # Placeholder - implement actual loading from database
        # orders = self.sales_purchase_service.get_all_sales_orders()
    
    def load_order_details(self, row, col):
        """Load order details when clicked"""
        # Implement loading order details
        pass
